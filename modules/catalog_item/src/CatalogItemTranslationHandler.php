...
/**
 * Defines the translation handler for catalog_items.
 */
class CatalogItemTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      // We do not need to show these values on catalog_item forms: they inherit the
      // basic catalog_item property values.
  ...
  protected function entityFormTitle(EntityInterface $entity) {
    $type_name = catalog_item_get_catalog_label($entity);
