...
/**
 * Assigns ownership of a catalog_item to a user.
 *
 * @Action(
 *   id = "catalog_item_assign_owner_action",
 *   label = @Translation("Change the curator of catalog item"),
 *   type = "catalog_item"
 * )
 */
class AssignOwnerCatalogItem extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new AssignOwnerCatalogItem action.
   *
