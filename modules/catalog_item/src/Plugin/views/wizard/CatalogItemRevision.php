...
namespace Drupal\catalog_item\Plugin\views\wizard;
...
/**
 * Tests creating catalog_item revision views with the wizard.
 *
 * @ViewsWizard(
 *   id = "catalog_item_revision",
 *   base_table = "catalog_item_field_revision",
 *   title = @Translation("Catalog Item revisions")
 * )
 */
class CatalogItemRevision extends WizardPluginBase {
   ...
   *
   * catalog_item revisions do not support full posts or teasers, so remove them.
   */
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['access']['options']['perm'] = 'view all catalog revisions';
    ...
    $display_options['fields']['changed']['table'] = 'catalog_item_field_revision';
    $display_options['fields']['changed']['field'] = 'changed';
    $display_options['fields']['changed']['entity_type'] = 'catalog_item';
    ...
    $display_options['fields']['title']['table'] = 'catalog_item_field_revision';
    $display_options['fields']['title']['field'] = 'title';
    $display_options['fields']['title']['entity_type'] = 'catalog_item';
  ...
  protected function defaultDisplayFiltersUser(array $form, FormStateInterface $form_state) {
    ...
    $catalog = $form_state->getValue(['show', 'catalog']);
    if ($catalog && $catalog != 'all') {
      $filters['catalog'] = [
        'id' => 'catalog',
        'table' => 'catalog_item_field_data',
        'field' => 'catalog',
        'relationship' => 'nid',
        'value' => [$catalog => $catalog],
        'entity_type' => 'catalog_item',
        'entity_field' => 'catalog',
        'plugin_id' => 'bundle',
      ];
    }
    return $filters;
  ...
  protected function buildDisplayOptions($form, FormStateInterface $form_state) {
    ...
    if (isset($display_options['default']['filters']['catalog'])) {
      $display_options['default']['relationships']['nid'] = [
        'id' => 'nid',
        'table' => 'catalog_item_field_revision',
        'field' => 'nid',
        'relationship' => 'none',
        'group_type' => 'group',
