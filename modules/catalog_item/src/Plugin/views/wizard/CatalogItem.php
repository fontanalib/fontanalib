...
/**
 * Tests creating catalog_item views with the wizard.
 *
 * @ViewsWizard(
 *   id = "catalog_item",
 *   base_table = "catalog_item_field_data",
 *   title = @Translation("Catalog Item")
 * )
 */
class CatalogItem extends WizardPluginBase {
   ...
   * @var string
   */
  protected $createdColumn = 'catalog_item_field_data-created';
  ...
  public function getAvailableSorts() {
    ...
    return [
      'catalog_item_field_data-title:ASC' => $this->t('Title'),
    ];
  }
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['access']['options']['perm'] = 'access catalog';
    ...
    $display_options['fields']['title']['table'] = 'catalog_item_field_data';
  ...
  protected function defaultDisplayFiltersUser(array $form, FormStateInterface $form_state) {
    ...
    if (!empty($tids)) {
      ...
      $filters['tid'] = [
        'id' => 'tid',
        'table' => 'catalog_taxonomy_index',
        'field' => 'tid',
        'value' => $tids,
        'vid' => $vid,
        'plugin_id' => 'catalog_item_taxonomy_index_tid',
      ];
  ...
  protected  function display_options_row(&$display_options, $row_plugin, $row_options) {
    switch ($row_plugin) {
      case 'full_posts':
        $display_options['row']['type'] = 'entity:catalog_item';
