...
// namespace Drupal\catalog_item\Plugin\views\argument_default;
...
//  *   id = "catalog_taxonomy_tid",
//  *   title = @Translation("Taxonomy term ID from URL (Catalog)")
//  * )
//  */
// class Tid extends ArgumentDefaultPluginBase implements CacheableDependencyInterface {
  ...
  //   $options['catalog_item'] = ['default' => FALSE];
  ...
  //   $form['catalog_item'] = [
  //     '#type' => 'checkbox',
  //     '#title' => $this->t("Load default filter from catalog_item page, that's good for related taxonomy blocks"),
  //     '#default_value' => $this->options['catalog_item'],
  //   ];
  ...
  //     '#states' => [
  //       'visible' => [
  //         ':input[name="options[argument_default][catalog_taxonomy_tid][catalog_item]"]' => ['checked' => TRUE],
  //       ],
  //     ],
  //   ];
  ...
  //     '#states' => [
  //       'visible' => [
  //         ':input[name="options[argument_default][catalog_taxonomy_tid][limit]"]' => ['checked' => TRUE],
  //         ':input[name="options[argument_default][catalog_taxonomy_tid][catalog_item]"]' => ['checked' => TRUE],
  //       ],
  //     ],
  //   ];
  ...
  //     }
  //   }
  //   // Load default argument from catalog_item.
  //   if (!empty($this->options['catalog_item'])) {
  //     // Just check, if a catalog_item could be detected.
  //     if (($catalog_item = $this->routeMatch->getParameter('catalog_item')) && $catalog_item instanceof CatalogItemInterface) {
  //       $taxonomy = [];
  //       foreach ($catalog_item->getFieldDefinitions() as $field) {
  //         if ($field->getType() == 'entity_reference' && $field->getSetting('target_type') == 'taxonomy_term') {
  //           $taxonomy_terms = $catalog_item->{$field->getName()}->referencedEntities();
