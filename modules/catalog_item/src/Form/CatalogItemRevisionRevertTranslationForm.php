...
/**
 * Provides a form for reverting a catalog_item revision for a single translation.
 *
 * @internal
 */
class CatalogItemRevisionRevertTranslationForm extends CatalogItemRevisionRevertForm {
  ...
  /**
   * Constructs a new CatalogItemRevisionRevertTranslationForm.
   *
   ...
   *   The time service.
   */
  public function __construct(EntityStorageInterface $catalog_item_storage, DateFormatterInterface $date_formatter, LanguageManagerInterface $language_manager, TimeInterface $time) {
    parent::__construct($catalog_item_storage, $date_formatter, $time);
  ...
  public function getFormId() {
    return 'catalog_item_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $catalog_item_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $catalog_item_revision);
  ...
  protected function prepareRevertedRevision(CatalogItemInterface $revision, FormStateInterface $form_state) {
    ...
    return $this->catalog_itemStorage->createRevision($translation, TRUE, $revert_untranslated_fields);
  }
